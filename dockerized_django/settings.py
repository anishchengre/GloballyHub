...
SECRET_KEY = 'django-insecure-*=ya=101%+eduxrd1e8-75jfxadf_wh!h*5&b@xm-wlse8ns!b'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'dockerized_django'),
        'USER': os.environ.get('POSTGRES_USER', 'anishchengre'),
